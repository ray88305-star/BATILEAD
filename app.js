...
class BatiLeadRealtimeFullStackApp {
  ...
  async signInWithGoogle() {
    this.logActivity("GOOGLE_AUTH_CLICK", "Clic sur Connexion avec Google");

    if (this.supabaseClient && this.supabaseClient.auth) {
      try {
        this.showToast("Redirection vers Google Sign-In...");
        ...
        this.showToast(`Google OAuth : ${e.message || 'Authentification active'}`);
      }
    } else {
      this.showToast("Service d'authentification en cours de connexion...");
    }
  }
