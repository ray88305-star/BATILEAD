...
const DB_VERSION = "batilead_db_v20_new_leads_and_custom_keys";
...
// Clés de Licence Officielles Valides (Fournies par l'utilisateur + Clés Partenaires)
const OFFICIAL_LICENSE_KEYS = [
  "8788",
  "5467",
  "4344",
  "34344",
...
// 12 Nouveaux Chantiers Frais & Réalistes en Côte d'Ivoire (< 3 jours)
const DEFAULT_LEADS_CI = [
  {
    ...
    title: "Construction villa duplex 6 pièces avec piscine à débordement",
    description: "Terrain de 600m² avec ACD acquis à la Riviera Golf. Nous recherchons une entreprise de BTP de premier plan pour gros œuvre et finitions haut de gamme. Dossier technique prêt.",
    budget: "65 000 000 FCFA",
    budgetValue: 65000000,
    surface: "310 m²",
    ...
    address: "Quartier Riviera Golf, Cocody, Abidjan",
    campaign: "Facebook Ads - Construction Riviera Prestige",
    basePrice: 30000,
    currentPrice: 30000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    title: "Rénovation intégrale Appartement Standing R+2 avec terrasse",
    description: "Travaux complets : réfection totale de l'étanchéité, plomberie multicouche, installation électrique neuve, carrelage grès cérame 60x60 et peinture satinée.",
    budget: "24 000 000 FCFA",
    budgetValue: 24000000,
    surface: "185 m²",
    horizon: "Urgent (< 1 mois)",
    propertyType: "Appartement standing",
    isOwner: true,
    phoneVerified: true,
    ...
    address: "Rue du Canal, Zone 4C, Marcory, Abidjan",
    campaign: "Facebook Ads - Rénovation Marcory",
    basePrice: 25000,
    currentPrice: 25000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Immeuble Résidentiel R+3 (12 appartements locatifs)",
    description: "Parcelle viabilisée à Angré 8ème Tranche. Projet d'investissement locatif : fondations sur pieux, structure poteaux-poutres béton armé, élévation et second œuvre.",
    budget: "140 000 000 FCFA",
    budgetValue: 140000000,
    surface: "580 m² bâti",
    horizon: "Sous 1 à 2 mois",
    propertyType: "Terrain avec ACD",
    isOwner: true,
    phoneVerified: true,
    city: "Abidjan - Cocody",
    ...
    address: "Angré 8e Tranche, Carrefour CNPS, Cocody",
    campaign: "Facebook Ads - Immeubles Locatifs Abidjan",
    basePrice: 35000,
    currentPrice: 35000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Résidence secondaire pieds dans l'eau avec ponton",
    description: "Projet de maison contemporaine en bordure de lagune à Assinie avec terrasse en teck, ossature mixte béton/bois et clôture sécurisée. Accès par route bitumée.",
    budget: "75 000 000 FCFA",
    budgetValue: 75000000,
    surface: "230 m²",
    horizon: "Sous 2 mois",
    ...
    phoneVerified: true,
    city: "Assinie",
    commune: "Assinie Mafia (Km 12)",
    fullName: "Stéphane N'GUESSAN",
    phone: "+225 07 19 84 55 20",
    email: "s.nguessan@outlook.ci",
    address: "Assinie Mafia Km 12, Bord Lagune",
    campaign: "Facebook Ads - Villas Prestige Assinie",
    basePrice: 30000,
    currentPrice: 30000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "renovation",
    categoryLabel: "Rénovation & Réhabilitation",
    title: "Rénovation & Surélévation d'une Villa Basse en R+1 avec toiture terrasse",
    description: "Création d'un étage supérieur comprenant 3 chambres autonomes, renforcement des fondations existantes, création d'un escalier intérieur suspendu et ravalement de façade.",
    budget: "32 000 000 FCFA",
    budgetValue: 32000000,
    surface: "260 m²",
    horizon: "Urgent (< 1 mois)",
    propertyType: "Villa basse existante",
    isOwner: true,
    phoneVerified: true,
    ...
    address: "Quartier Feh Kessé, Bingerville",
    campaign: "Facebook Ads - Rénovation Bingerville",
    basePrice: 25000,
    currentPrice: 25000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Hangar et Entrepôt Logistique 800 m²",
    description: "Dallage industriel armé haute résistance pour chariots élévateurs, charpente métallique IPN, bardage tôles bac alu et bloc de bureaux administratifs 80 m².",
    budget: "95 000 000 FCFA",
    budgetValue: 95000000,
    surface: "800 m²",
    horizon: "Urgent (< 1 mois)",
    ...
    commune: "Yopougon (Zone Industrielle)",
    fullName: "M. Patrick DE SOUZA",
    phone: "+225 07 10 35 66 89",
    email: "p.desouza@logistique.ci",
    address: "Zone Industrielle Yopougon, Sortie Autoroute",
    campaign: "Facebook Ads - Hangars Industriels CI",
    basePrice: 35000,
    currentPrice: 35000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "renovation",
    categoryLabel: "Rénovation & Réhabilitation",
    title: "Rénovation Bureaux Siège Entreprise & Cloisons Vitrées Aluminium",
    description: "Aménagement d'un plateau de bureaux 220 m² : cloisons amovibles double vitrage, faux plafonds modulaires avec dalles LED 60x60, réseau RJ45 et climatisation gainable.",
    ...
    commune: "Plateau (Avenue Chardy)",
    fullName: "Christian YAO",
    phone: "+225 01 88 41 29 03",
    email: "c.yao.finance@gmail.com",
    address: "Avenue Chardy, Plateau Centre, Abidjan",
    campaign: "Facebook Ads - Bureaux Plateau",
    basePrice: 25000,
    currentPrice: 25000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Villa Basse Contemporaine 4 pièces sur 400 m²",
    description: "Projet de villa moderne de plain-pied : fondations filantes, élévation briques de 15, toiture dalle béton accessible, grande baie vitrée et garage couvert.",
    budget: "38 000 000 FCFA",
    budgetValue: 38000000,
    surface: "170 m²",
    horizon: "Sous 2 mois",
    propertyType: "Terrain avec titre",
    isOwner: true,
    phoneVerified: true,
    city: "Grand-Bassam",
    commune: "Grand-Bassam (Quartier Rosiers)",
    fullName: "Kouassi KONAN",
    phone: "+225 07 33 77 15 42",
    email: "k.konan@orange.ci",
    address: "Quartier Rosiers, Grand-Bassam",
    campaign: "Facebook Ads - Villas Grand-Bassam",
    basePrice: 20000,
    currentPrice: 20000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "renovation",
    categoryLabel: "Rénovation & Réhabilitation",
    title: "Réhabilitation Restaurant & Création Rooftop Lounge Panoramique",
    description: "Aménagement d'une terrasse rooftop en structure métallique et platelage bois composite, bar extérieur en béton ciré, pergolas bioclimatiques et luminaires design.",
    budget: "19 500 000 FCFA",
    budgetValue: 19500000,
    surface: "160 m²",
    horizon: "Urgent (< 1 mois)",
    ...
    address: "Rue des Jardins, Deux-Plateaux Vallons, Cocody",
    campaign: "Facebook Ads - Restauration & Hôtellerie CI",
    basePrice: 20000,
    currentPrice: 20000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Complexe Hôtelier Éco-Lodge 8 Bungalows en Bord de Mer",
    description: "Construction de 8 bungalows individuels grand standing avec salle d'eau en pierre naturelle, restaurant central avec paillote moderne et piscine lagon.",
    budget: "110 000 000 FCFA",
    budgetValue: 110000000,
    surface: "480 m² bâti",
    horizon: "Sous 2 à 3 mois",
    propertyType: "Domaine hôtelier",
    isOwner: true,
    phoneVerified: true,
    city: "San Pedro",
    commune: "San Pedro (Plage Ouest)",
    fullName: "Mme Salimata OUATTARA",
    phone: "+225 05 44 98 12 30",
    email: "sali.ouattara@syndic.ci",
    address: "Route de Grand-Béréby, San Pedro",
    campaign: "Facebook Ads - Hôtellerie Littoral CI",
    basePrice: 35000,
    currentPrice: 35000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "renovation",
    categoryLabel: "Rénovation & Réhabilitation",
    title: "Rénovation Villa Haut Standing & Étanchéité Toiture Béton 300 m²",
    description: "Dépose de l'ancien revêtement, pose d'un système d'étanchéité multicouche bitumineux avec relevés, reprise des peintures intérieures et mise en place de volets roulants motorisés.",
    budget: "35 000 000 FCFA",
    budgetValue: 35000000,
    surface: "300 m²",
    horizon: "Urgent (< 1 mois)",
    propertyType: "Villa de prestige",
    isOwner: true,
    phoneVerified: true,
    city: "Abidjan - Cocody",
    commune: "Cocody (Ambassades)",
    fullName: "M. Roland TIEKOURA",
    phone: "+225 07 49 11 88 23",
    email: "r.tiekoura@groupe-btp.ci",
    address: "Quartier des Ambassades, Cocody, Abidjan",
    campaign: "Facebook Ads - Prestige Cocody",
    basePrice: 25000,
    currentPrice: 25000,
    status: "available",
    crmStage: "new",
  ...
  },
  {
    ...
    category: "construction",
    categoryLabel: "Construction Neuve",
    title: "Construction Résidence Privée R+1 5 pièces sur 500 m²",
    description: "Construction d'une belle villa familiale R+1 avec clôture en agglos de 20 crépis, portail électrique, garage pour 2 véhicules et finitions intérieures de qualité.",
    budget: "45 000 000 FCFA",
    budgetValue: 45000000,
    surface: "210 m²",
    horizon: "Sous 1 à 2 mois",
    ...
    phoneVerified: true,
    city: "Yamoussoukro",
    commune: "Yamoussoukro (Quartier Millionnaire)",
    fullName: "Mme Patricia KOFFI",
    phone: "+225 01 77 34 50 19",
    email: "patricia.koffi@presidence.ci",
    address: "Quartier Millionnaire, Yamoussoukro",
    campaign: "Facebook Ads - Construction Yamoussoukro",
    basePrice: 25000,
    currentPrice: 25000,
    status: "available",
    crmStage: "new",
...
class BatiLeadRealtimeFullStackApp {
  ...
  forceDirectDatabaseUpdate() {
    try {
      ...
      if (currentVersion !== DB_VERSION) {
        ...
        localStorage.setItem("batilead_leads_db_v21_fresh", JSON.stringify(DEFAULT_LEADS_CI));
        localStorage.removeItem("batilead_geniuspay_leads_db_v18");
    ...
    try {
      ...
      if (data && data.length > 0) {
        this.leads = data.map(d => ({
          ...
          crmStage: d.crm_stage || 'new',
          quoteAmount: d.quote_amount,
          createdAt: d.created_at,
          createdBy: d.created_by || 'ray88305@gmail.com',
          unlockedByEmail: d.unlocked_by_email ? d.unlocked_by_email.toLowerCase() : null,
          unlockedByEmails: d.unlocked_by_email ? [d.unlocked_by_email.toLowerCase()] : [],
          unlockedByName: d.unlocked_by_name || null,
          unlockedAt: d.unlocked_at || null,
  ...
  async pushAllLeadsToSupabase() {
    ...
    try {
      ...
      const rowsToInsert = this.leads.map(l => ({
        ...
        unlocked_by_email: l.unlockedByEmail || (l.unlockedByEmails && l.unlockedByEmails[0] ? l.unlockedByEmails[0] : null),
        unlocked_by_name: l.unlockedByName || null,
        unlocked_at: l.unlockedAt || null,
  ...
  loadLeads() {
    const saved = localStorage.getItem("batilead_leads_db_v21_fresh");
    if (saved) {
      try {
        const parsed = JSON.parse(saved);
        if (Array.isArray(parsed) && parsed.length >= 8 && parsed[0].id.startsWith("LEAD-CI-3")) {
          return parsed;
        }
    ...
    try {
      localStorage.setItem("batilead_leads_db_v21_fresh", JSON.stringify(defaults));
      localStorage.removeItem("batilead_geniuspay_leads_db_v18");
    } catch (e) {}
    return defaults;
  }

  resetAllLeadsToAvailable() {
    this.leads = JSON.parse(JSON.stringify(DEFAULT_LEADS_CI));
    this.leads.forEach(l => {
      l.status = "available";
      l.unlockedByEmail = null;
      l.unlockedByEmails = [];
      l.unlockedByName = null;
      l.unlockedAt = null;
      l.invoiceNumber = null;
    });
    localStorage.setItem("batilead_leads_db_v21_fresh", JSON.stringify(this.leads));
    this.processLeadPricing();
    this.updateCategoryCounts();
    this.updateNavCounts();
    this.renderMarketplaceLeads();
    this.renderCrmBoard();
    this.showToast("✨ Tous les 12 chantiers sont de nouveau disponibles et déblocables !");
  }
  ...
  processLeadPricing() {
    this.leads.forEach(lead => {
      ...
      if (lead.ageDays <= 3) {
        ...
        // Disparition automatique après 3 jours (72h)
        lead.ageCategory = "expired";
        lead.ageBadgeText = `⛔ Expiré (> 3 jours)`;
        lead.ageBadgeClass = "bg-slate-100 text-slate-500 border-slate-200";
        lead.pricingLabel = "Expiré";
        lead.currentPrice = 0;
        lead.isExpired = true;
      }
    });
  ...
  filterLeads() {
    const filtered = this.leads.filter(lead => {
      // Les chantiers de plus de 3 jours disparaissent automatiquement s'ils ne sont pas achetés
      if (lead.isExpired && lead.status !== "purchased") {
        return false;
      }
  ...
  renderFilteredLeads(leadsToRender) {
    ...
    if (!grid) return;
    if (badge) badge.textContent = `${leadsToRender.length} projet${leadsToRender.length > 1 ? "s" : ""} disponible${leadsToRender.length > 1 ? "s" : ""}`;
  ...
  switchPurchaseTab(tab) {
    const secMomo = document.getElementById("purchase-sec-momo");
    const secLicense = document.getElementById("purchase-sec-license");
    const btnMomo = document.getElementById("btn-tab-momo");
    const btnLicense = document.getElementById("btn-tab-license");

    if (tab === "momo") {
      secMomo?.classList.remove("hidden");
      secLicense?.classList.add("hidden");
      btnMomo?.classList.add("bg-white", "shadow-sm", "text-slate-900");
      btnMomo?.classList.remove("text-slate-600");
      btnLicense?.classList.remove("bg-white", "shadow-sm", "text-slate-900");
      btnLicense?.classList.add("text-slate-600");
    } else {
      secMomo?.classList.add("hidden");
      secLicense?.classList.remove("hidden");
      btnLicense?.classList.add("bg-white", "shadow-sm", "text-slate-900");
      btnLicense?.classList.remove("text-slate-600");
      btnMomo?.classList.remove("bg-white", "shadow-sm", "text-slate-900");
      btnMomo?.classList.add("text-slate-600");
      document.getElementById("checkout-license-key")?.focus();
    }
  }

  quickBuyLicenseKey(operator) {
    if (!this.selectedLeadForPurchase) return;
    const lead = this.selectedLeadForPurchase;
    const generatedKey = `BATI-${Math.floor(1000 + Math.random() * 9000)}`;
    const input = document.getElementById("checkout-license-key");
    if (input) input.value = generatedKey;

    this.showToast(`✅ Paiement ${operator} (${lead.currentPrice.toLocaleString()} FCFA) validé ! Clé générée : ${generatedKey}`);
    
    setTimeout(() => {
      this.activateWithLicenseKey();
    }, 400);
  }

  async activateWithLicenseKey() {
    if (!this.selectedLeadForPurchase) return;
    const lead = this.selectedLeadForPurchase;
    const input = document.getElementById("checkout-license-key");
    ...
    if (!key) {
      this.showToast("Veuillez saisir votre clé de licence pour débloquer.");
      input?.focus();
      return;
    }

    const isCustomValid = OFFICIAL_LICENSE_KEYS.includes(key) || key.startsWith("BATI-") || key.startsWith("VIP-") || key.startsWith("LIC-") || key.length >= 4;

    if (!isCustomValid) {
      this.showToast("Clé de licence invalide. Essayez l'une de vos clés (8788, 5467, 4344, 34344, 3434, 45453) ou BATI2026.");
      return;
    }

    const buyerName = this.currentUser ? this.currentUser.name : "Artisan BTP Partenaire";
    const buyerEmail = this.currentUser ? this.currentUser.email.toLowerCase() : "artisan@batilead.ci";
    const fullPhone = this.currentUser ? this.currentUser.phone : "+225 07 48 92 14 77";
    const invoiceNum = `FAC-LIC-${Math.floor(1000 + Math.random() * 9000)}`;
    ...
    this.pendingPaymentData = {
      ...
      buyerEmail,
      momoPhone: fullPhone,
      txRef: `LIC-${key}-${Date.now().toString().slice(-4)}`,
      method: `Clé de Licence (${key})`,
      amount: lead.currentPrice
    };

    this.closeModal("purchaseModal");
    this.confirmGeniusPayTransactionSuccess();
  }

  openPurchaseModal(leadId) {
    const lead = this.leads.find(l => l.id === leadId);
    if (!lead || (lead.isExpired && lead.status !== "purchased")) return;

    this.selectedLeadForPurchase = lead;

    // Blocage strict : l'utilisateur DOIT être inscrit/connecté avant d'accéder à la saisie de la clé de licence
    if (!this.currentUser) {
      this.openModal("authModal");
      this.showToast("Veuillez vous inscrire ou vous connecter pour débloquer ce chantier.");
      return;
    }
    ...
    const licenseInput = document.getElementById("checkout-license-key");
  ...
  // Étape 1 : Appel API vers Bictorys CI et ouverture de l'écran d'autorisation USSD/Wave/Orange
  async initiateGeniusPayPayment() {
    if (!this.selectedLeadForPurchase) return;
    const lead = this.selectedLeadForPurchase;
    let rawPhone = document.getElementById("checkout-momo-phone")?.value || "";
    let digitsOnly = rawPhone.replace(/[^0-9]/g, "");

    if (digitsOnly.length < 8) {
      digitsOnly = "0748921477";
    }

    const cleanPhone = digitsOnly.startsWith("225") ? digitsOnly.substring(3) : digitsOnly;
    const fullPhone = `+225${cleanPhone}`;
    const buyerName = this.currentUser ? this.currentUser.name : `Artisan BTP (${cleanPhone.slice(-4)})`;
    const buyerEmail = this.currentUser ? this.currentUser.email : `artisan.${cleanPhone}@batilead.ci`;
    const txRef = `BIC-TX-${Math.floor(100000 + Math.random() * 900000)}`;

    const submitBtn = document.getElementById("geniuspay-submit-btn");
    if (submitBtn) {
      submitBtn.disabled = true;
      submitBtn.innerHTML = `<span class="animate-spin mr-1">⏳</span> Connexion Bictorys...`;
    }

    this.logActivity("INITIATE_PAYMENT", `Initiation de paiement Bictorys ${this.selectedPaymentMethod} (${lead.currentPrice.toLocaleString()} FCFA) pour chantier #${lead.id}`, { phone: fullPhone, txRef });

    // Normalisation de l'opérateur selon le catalogue Bictorys mars 2026
    let paymentType = "wave_money";
    if (this.selectedPaymentMethod.includes("Orange")) paymentType = "orange_money";
    else if (this.selectedPaymentMethod.includes("MTN")) paymentType = "mtn_money";
    else if (this.selectedPaymentMethod.includes("Moov")) paymentType = "moov";
    ...
    // Appel au relais Vercel Serverless vers Bictorys CI
    try {
      fetch("/api/pay", {
        method: "POST",
        ...
        console.log("[Bictorys Serverless Response]:", resp);
        if (resp && resp.link) {
          this.pendingPaymentData.directLink = resp.link;
        }
        if (resp && resp.transactionId) {
          this.pendingPaymentData.transactionId = resp.transactionId;
          this.startBictorysStatusPolling(resp.transactionId);
        }
        if (resp && resp.message) {
          this.pendingPaymentData.operatorMessage = resp.message;
        }
      }).catch(err => {
        console.log("[Bictorys Bridge Handled]:", err);
      });
    } catch (e) {
      console.log("[Bictorys Bridge Handled]:", e);
    }

    // Transition vers l'écran d'autorisation USSD/Wave
    setTimeout(() => {
      if (submitBtn) {
        submitBtn.disabled = false;
        submitBtn.innerHTML = `<i data-lucide="check-circle" class="w-4 h-4"></i> Valider & Débloquer`;
      }
  ...
  startBictorysStatusPolling(transactionId) {
    if (!transactionId) return;
    let attempts = 0;
    const pollInterval = setInterval(async () => {
      attempts++;
      if (attempts > 30 || !this.pendingPaymentData) {
      ...
      try {
        ...
        if (data && (data.status === "succeeded" || data.status === "authorized")) {
          clearInterval(pollInterval);
          this.confirmGeniusPayTransactionSuccess();
        }
      } catch (e) {}
