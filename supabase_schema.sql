...
CREATE POLICY "sessions_allow_all" ON public.user_sessions_log FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "leads_allow_all" ON public.leads FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "orders_allow_all" ON public.orders FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "logs_allow_all" ON public.audit_activity_logs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "disputes_allow_all" ON public.disputes_guarantee_logs FOR ALL USING (true) WITH CHECK (true);
